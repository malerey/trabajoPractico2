...
console.log("Resultado punto 1a -->",precioMaquina(["Monitor GPRS 3000", "Motherboard ASUS 1500"]));
console.log("Resultado punto 1a -->",precioMaquina(["Monitor GPRS 3000", "Motherboard ASUS 1500"]));
console.log("Resultado punto 1a -->",precioMaquina(["Monitor ASC 543", "Motherboard MZI"]));
console.log("Resultado punto 1a -->",precioMaquina(["Monitor ASC 543", "Motherboard ASUS 1200"]));
console.log("Resultado punto 1a -->",precioMaquina(["Monitor GPRS 3000", "Motherboard ASUS 1200"]));
...
console.log("Resultado punto 1b -->",cantidadVentasComponente("Monitor GPRS 3000")); //3
console.log("Resultado punto 1b -->",cantidadVentasComponente("Motherboard ASUS 1500")); //2
console.log("Resultado punto 1b -->",cantidadVentasComponente("Monitor ASC 543")); //2
console.log("Resultado punto 1b -->",cantidadVentasComponente("Motherboard ASUS 1200")); //2
console.log("Resultado punto 1b -->",cantidadVentasComponente("Motherboard MZI")); //1
console.log("Resultado punto 1b -->",cantidadVentasComponente("HDD Toyiva")); //0
console.log("Resultado punto 1b -->",cantidadVentasComponente("HDD Wezter Dishital")); //0
console.log("Resultado punto 1b -->",cantidadVentasComponente("RAM Quinston")); //0
console.log("Resultado punto 1b -->",cantidadVentasComponente("RAM Quinston Fury")); // 0
...
console.log("Resultado punto 1d -->", ventasMes(1, 2019)); // 1250
console.log("Resultado punto 1d -->",ventasMes(2, 2019)); // 320
...
//             Sucursal += precioMaquina(local.ventas[i].componentes)
//         }
//     }
...
//opcion para aprovechar que tiene cosas en comun con otra funcion
...
// console.log("Resultado funcion Sucursal ",Sucursal("Grace")); // 900
// console.log("Resultado funcion Sucursal ",Sucursal("Ada")); // 670
...
//Parte 2d - opcion para aprovechar que tiene cosas en comun con otra funcion
function ventasSucursalVendedora(string) {
    var total = 0;
...
//Las funciones ventasSucursal y Sucursal tienen mucho código en común, ya que es la misma funcionalidad pero 
...
console.log("Resultado punto 2f -->",sucursalDelMes(1, 2019)); // "Centro"

//Parte 3a - imprime un undefined porque no estoy retornando nada. Acorde dejarlo asi para no poner una var random y retornarla.
...
//Parte 3b - imprime un undefined porque no estoy retornando nada. Acorde dejarlo asi para no poner una var random y retornarla.
function renderPorSucursal(){

   for (var a = 0; a < local.sucursal.length; a++) {
       console.log("Total de " + local.sucursal[a] + ": " + ventasSucursalVendedora(local.sucursal[a]))
   }
...
function render() {
    ...
    for (var b = 0; b < local.vendedoras.length; b++) {
        ...
        objetoNuevo.nombre = local.vendedoras[b];
        objetoNuevo.ventas = ventasSucursalVendedora(local.vendedoras[b]);
    ...
    for (var t = 0; t < local.vendedoras.length; t++) {
        montosTotales.push(ventasSucursalVendedora(local.vendedoras[t]));
    }
